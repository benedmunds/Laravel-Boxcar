...
*         @benedmunds
*
* Location: http://github.com/benedmunds/Laravel-Boxcar
*
* Created:  05.29.2012
*
* Description:  Modified Boxcar.io PHP API SDK to work as a Laravel bundle
*
...
class Boxcar {
	 ...
	 * @param string $default_icon_url url to a 57x57 icon to use with a message
	 */
	public static function init($api_key, $secret, $default_icon = null) {
